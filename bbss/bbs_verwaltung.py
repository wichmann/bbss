...
def _read_student(row, student_list):
    ...
    mail_adress = row[1]
    bbs_verwaltung_username = row[2]
    surname = row[3]
    firstname = row[4]
    classname = row[5]
    courses = row[6]
    birthday = row[7]
    bbs_verwaltung_password = row[8]
    ...
    try:
        ...
        # include username and password generated by BBS Verwaltung in the Student data
        new_student.initial_username = bbs_verwaltung_username
        new_student.initial_password = bbs_verwaltung_password
