...
class Ui_BBSS_Main_Window(object):
    def setupUi(self, BBSS_Main_Window):
        ...
        self.gridLayout.addWidget(self.import_data_button, 4, 1, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout.addWidget(self.delete_database_button, 4, 2, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout.addWidget(self.load_file_button, 4, 0, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout.addWidget(self.import_filter_text, 3, 1, 1, 2)
